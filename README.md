...
**Для кого:** аналитики рынка труда, HR, карьерные консультанты и все, кто хочет видеть реальный спрос на навыки, а не гадать. Я собрал его, чтобы ответить на свой вопрос «какие навыки рынок просит чаще» — обработано 1000+ вакансий.
...
Спроектирован мной, собран через Claude Code — это мой рабочий метод: архитектура, структура данных и словари навыков мои, кодовую базу генерировал и дорабатывал с AI-ассистентом. 30 Python-модулей, 35 тестов, Docker-развёртывание. Статус — личный рабочий инструмент (pet-проект), использую его данные для аналитики рынка.

## Контакты

**Автор:** Алексей Черненко — AI-интегратор и Product Engineer  
**Telegram:** [@alex_chnk](https://t.me/alex_chnk)  
**GitHub:** [github.com/LongWinterNight](https://github.com/LongWinterNight)

---

**Версия:** 1.2.0 · Лицензия: [MIT](LICENSE)
