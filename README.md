...
Проект сделан, чтобы видеть реальный спрос на навыки по данным, а не по ощущениям. Обработано более 1000 вакансий; подойдёт аналитикам рынка труда, HR и карьерным консультантам.

![Панель управления](docs/screenshot.png)
...
Архитектура, структура данных и словари навыков спроектированы автором; код написан в связке с Claude Code. 30 Python-модулей, 35 тестов, Docker-развёртывание. Личный рабочий инструмент, используется для аналитики рынка.
